  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value, record, index) => {
        ...
        if (record.isSubtotal) {
          return (
            <div style={{ textAlign: 'right', fontWeight: 'bold', color: PRIMARY_BLUE }}>
    ...
    },
    {
      ...
      render: (value, record, index) => {
        ...
        if (record.isSubtotal) {
          return (
            <div style={{ textAlign: 'right', fontWeight: 'bold', color: "#fa8c16" }}>
    ...
    },
    {
      ...
      render: (value, record) => {
        ...
        if (record.isSubtotal) {
          return (
            <Tag
              color={subtotals.headroom < 0 ? "red" : 
                     subtotals.headroom === 0 ? "orange" : "green"}
              style={{ 
                fontWeight: 'bold',
                fontSize: '13px',
                padding: '4px 12px',
